...
void rotateTestingFunct(){
    ...
    point2.setLatitude(78.78);
    point2.setLongitude(87.87);
    ...
    QJsonObject rotatedFeature = ModifierClass::rotateModifier(lineCenter,60,lineFeature);
    ...
    UnitTest::testOfRotation(orgCoordsArray,rotatedCoordsArray,lineCenter,60) ;
