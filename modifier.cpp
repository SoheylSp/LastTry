...
QJsonObject ModifierClass::scaleModifier(QGeoCoordinate scalePoint, double scaleNumber, QJsonObject feature)
{
    ...
    if (geometryType == "Point") {
        ...
        if (geometryType == "LineString") {
            ...
            for (int i = 0; i < coordinates.size(); ++i) {
                QJsonArray coordinatePair = coordinates[i].toArray();
                ...
                // Update the coordinates
                QJsonArray scaledCoordinatePair;
                scaledCoordinatePair.append(scaledPoint.longitude());
                scaledCoordinatePair.append(scaledPoint.latitude());
