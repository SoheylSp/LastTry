     ...
     if(geometryType == "Polygon"){
         ...
         for(const QJsonValue &polyCoordinates : polygonCoordinates){
             ...
             for(const QJsonValue &coord : coordinates){
                 ...
                 QGeoCoordinate rotatedCoord = rotatePoint.atDistanceAndAzimuth(distance,azimuth) ;

                 //Update the coordiante

                 newCoordinates.append(rotatedCoord.longitude()) ;
                 newCoordinates.append(rotatedCoord.latitude()) ;
         ...
         for(const QJsonValue &coord : coordinates){
             ...
             //Calculate the new coordiante

             QGeoCoordinate rotatedCoord = rotatePoint.atDistanceAndAzimuth(distance,azimuth);
             //Update the coordinates

             newCoordinate.append(rotatedCoord.longitude()) ;
             newCoordinate.append(rotatedCoord.latitude())  ;
         ...
         newGeometry["coordinates"] = newCoordinate ;
         rotatedFeature["geometry"] = newGeometry ;
