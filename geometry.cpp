...
QJsonObject GeoGraphClass::createLineFeature(const QList<QGeoCoordinate> &myCoordinates)
{
    ...
    qDebug()<<"Creating line feature with coordinates : " << myCoordinates << "\n";
    ...
    for(const QGeoCoordinate &coordinate : myCoordinates){
        ...
        QJsonArray coordiantePair ;

        coordiantePair.append(coordinate.longitude()) ;
        coordiantePair.append(coordinate.latitude())  ;
        coordinatesArray.append(coordiantePair)   ;
